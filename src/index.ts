...
// (TEMP) Задачи на данный момент:
// 1) Доделать фичи авторизации (наибольший приоритет):
// - TODO (feat): продумать важный механизм...
// - Добавить роли (см. гайд Простая авторизация на NODE JS - ulbi tv)... + добавить роли в payload jwt
// - Добавить отправку кода или ссылки подтверждения на почту (если подтверждена)...
// - Продумать смену почты и пароля...
// - Продумать защищенные эндпоинты
...
// - Поправить тесты...
// 2) После реализации основных фич делать рефакторинг и всё остальное
...
// - Сделать миграцию БД
// - Убедиться, что токены везде верифицируются и нет дыр безопасности
// - Убрать хардкод /api/auth/verify-email/: для этого нужно создать файл config/routes.ts
...
// - Можно заменить в контроллерах отправку ответа на выброс ошибок при возникновении ошибок
