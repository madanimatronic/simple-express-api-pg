...
// при логине и прочих действиях, требующих подтверждения
...
// - Можно заменить в контроллерах отправку ответа на выброс ошибок
// если не соблюдаются какие-то условия или что-то идёт не так (рефакторинг)
// - Сделать несколько refresh токенов для одного пользователя,
// чтобы можно было пользоваться с нескольких устройств. См. продумать важный механизм...
// Покрыть тестами остальной код (авторизацию, токен сервис, роли и т.д.).
